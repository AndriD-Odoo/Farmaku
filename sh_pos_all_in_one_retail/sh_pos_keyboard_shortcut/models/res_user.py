...
class ShKeyboardKeyTemp(models.Model):
    ...
    sh_pos_key_ids = fields.Many2one('sh.pos.keyboard.shortcut', string="POS Keys")
...
class ShPosKeyboardShortcut(models.Model):
    ...
    sh_payment_shortcut_screen_type = fields.Selection(
        [('payment_screen', 'Payment Screen')], string="Payment Shortcut Screen Type", default="payment_screen")
    ...
    sh_shortcut_screen = fields.Selection([
        ...
        ('select_up_order', 'Select Up Order'), ('select_order', 'Select Order'),
        ('bundle_product_info', 'Show Bundle Product Info'),
        ('pricelist_info', 'Show Pricelist Info'),
        ('warehouse_info', 'Show Warehouse Info'),
        ('add_line_note', 'Add Line Note'),
